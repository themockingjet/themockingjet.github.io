...
function App() {
    return (
        <div className="min-h-screen bg-gradient-to-bl from-gray-900 to-black text-gray-100 font-sans">
            <div className="lg:container mx-auto px-4 py-8 md:px-8 md:py-12 flex flex-col min-h-screen">
                <header className="mb-6 pb-6">
                    <h1 className="text-4xl lg:text-7xl font-bold">themockingjet</h1>
