                        ...
                        <section id="description" className="w-full mb-8">
                            <div className="max-w-3xl">
                                ...
                                <p className="text-gray-300 leading-relaxed text-lg mt-4">
                                    I create automation tools using AutoHotkey and build CLI
                                    apps with Python. Lately, I've been learning web
                                    development by working on personal projects with
                                ...
                                <div className="mt-4 text-sm text-gray-400 flex items-center font-sans italic">
                                    ...
                                    This site is evolving — check back later for new projects
                                    and updates.
                                </div>
                            </div>
                        </section>
